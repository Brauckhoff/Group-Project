...
SRRs=("SRR11606871 SRR15275213 SRR15275212 SRR15275211 SRR15275210 ERR10905741 ERR10905742 ERR10905743 SRR14289618")

# iterate over individual assemblies
for i in $SRRs
do
   echo "metaMDBG asm --out-dir ./$i/ --in-hifi /teachstor/share/groupprojectWS25/groupC/data/fastq/$i.fastq.gz --threads 50 --kmer-size 13"
done
...
echo "metaMDBG asm --out-dir ./co-assembly_human/ --in-hifi $g1 $g2 $g3 $g4 --threads 50 --kmer-size 13"
...
echo "metaMDBG asm --out-dir ./co-assembly_human/ --in-hifi $ad1 $ad2 $ad3 --threads 50 --kmer-size 13"
